...
const generateFirstModalContent = () => {
  ...
  const bouttonAjoutProjet = document.createElement("button");
  bouttonAjoutProjet.innerHTML = "Ajouter une photo";
  bouttonAjoutProjet.addEventListener("click", generateSecondModal);
  modalContent.appendChild(bouttonAjoutProjet);
};
